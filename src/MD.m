...
% retrieved from the folder 'MD' (Maximum Determinant). You can download
% the content of the 'MD' folder from this link:
...
try
    ...
    disp(['File not found. Download the extremal point systems from' ...
        ' https://web.maths.unsw.edu.au/~rsw/Sphere/MaxDet/MaxDet1.html#ExtSys' ...
