%% Description:
%
% Computation of the truncated series expansion of the diagonal of the
% reproducing kernel, i.e. '\mu_N^{-1}(zeta)'. It is necessary to treat
% separately the case in which smpl='deterministic', due to the Cartesian
% product structure of the evanescent plane wave parameters.
...
%  OUTPUT:
%
% - muN:    truncated series expansion of the diagonal of
%           the reproducing kernel, i.e. '\mu_N^{-1}(zeta)'
